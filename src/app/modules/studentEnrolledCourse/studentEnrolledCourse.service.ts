...
const deleteSingleStudentEnrolledCourse = async (req: Request): Promise<IGenericResponse> => {
  const id = req.params.id;
...
const updateSingleStudentEnrolledCourse = async (req: Request): Promise<IGenericResponse> => {
  const id = req.params.id;
